...
\title{GNNs for Technology Monitoring: how much graph structure helps predicting emerging technologies?}
...
\section*{Abstract}
Scientific discovery and technological innovation are tightly interdependent processes, and their progress depends on sustained collaboration across domains, from fundamental theory to applied engineering. This suggests that tracking how such collaborations evolve over time may improve our understanding of technological adoption. In this paper, we investigate this hypothesis using neural network models on graph-structured data related to the cybersecurity in space domain. Our central objective is to determine whether the structure and temporal evolution of collaboration graphs provide informative signals about the future technological landscape of this domain. By modeling relational patterns among scientific and technical features such as citation and concept co-occurences, we aim to quantify the predictive value of graph topology beyond non-relational information alone.
\newpage
...
The specificity of this study, that has not been much explored in the current litterature so far, is that it insists on the benefits of the graph structure, testing different models to check if hidden structures in the graph topolgy evolution could be leveraged into better predictions.
...
The framework on which our study rely on can be stated rigorously in Shannon terms.
...
To conduct this study, we use the OpenAlex dataset, an open source dataset that gather scientific articles from various topics.
...
For every month, we compute adjacency matrices of the graphs where nodes represent the cleaned keywords and weighted edges summaries joint mentions (co-occurrences) in the abstracts (see Figure \ref{fig:procedure}).

\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \includegraphics[width=1.3\textwidth]{figures/keyword_graph_template.pdf}%
    }
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{figures/GTAN_architecture.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\linewidth,trim=0 0 0 0.82cm,clip]{figures/counts_stage1_purge.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__inputs_seen_per_feature_former_dashed.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.98\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__citation_flow_and_cumulative_overall.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.98\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__aggregate_raw_balanced_fw_2005_2025.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_raw_xcum_frac_split_ordered_by_fw_aggregate_2025-10-01.pdf}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_raw_oc_freq_ordered_by_fw_aggregate_2025-10-01.pdf}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_raw_edge_weight_ordered_by_fw_aggregate_2025-10-01.pdf}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_fw_aggregate_balanced_fw_ordered_by_fw_aggregate_2025-10-01.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.48\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__topk_heatmap_xcum_frac_split_ordered_by_fw_aggregate_2025-10-01.pdf}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__topk_heatmap_oc_freq_ordered_by_fw_aggregate_2025-10-01.pdf}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__topk_heatmap_edge_weight_ordered_by_fw_aggregate_2025-10-01.pdf}
    ...
    \begin{subfigure}[t]{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__topk_heatmap_fw_aggregate_ordered_by_fw_aggregate_2025-10-01.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.88\linewidth]{figures/EM_raw_Eps1e-8_F24_W12__bubble_growth_fw_aggregate_2025-10.pdf}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[t]{0.49\linewidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_lag12_xcum_frac_split.pdf}
    ...
    \begin{subfigure}[t]{0.49\linewidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_lag12_oc_freq.pdf}
    ...
    \begin{subfigure}[t]{0.49\linewidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_lag12_edge_weight.pdf}
    ...
    \begin{subfigure}[t]{0.49\linewidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_lag12_fw_aggregate.pdf}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_smooth_trailing12_lag12_xcum_frac_split.pdf}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_smooth_trailing12_lag12_oc_freq.pdf}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_smooth_trailing12_lag12_edge_weight.pdf}
    ...
    \begin{subfigure}[t]{0.49\textwidth}
      \centering
      \includegraphics[width=\linewidth]{figures/EM_raw_Eps1e-08_F8_W12__heatmap_relative_smooth_trailing12_lag12_fw_aggregate.pdf}
...
For the block-stacked diagnostics run reported here (4 blocks x 7 models), the end-to-end wall-clock time was approximately 33~min~59~s.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth]{figures/learning_curves_all_models_from_log.pdf}
...
\section{Conclusion}
For technology monitoring, one implication is that, in the present bibliometric use case, explicitly modeling the graph topology of the scientific landscape does not appear to be necessary for anticipating future technological momentum. Although this conclusion may seem counterintuitive, a plausible explanation is that much of the useful topological information is already absorbed into the temporal histories of individual concepts. Repeated co-occurrence structure shapes node-level feature trajectories over time, so part of the graph signal may already be encoded in those past traces before message passing is applied.

Overall, based on the data used here, this study does not support a strong claim that graph neural networks automatically improve bibliometric technology monitoring. It does, however, clarify the conditions under which they might help.
